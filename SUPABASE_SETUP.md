...
11. Add these Sites environment variables:
...
12. Mark `CATALINA_SUPABASE_SERVICE_ROLE_KEY`, `STRIPE_SECRET_KEY`, and `STRIPE_WEBHOOK_SECRET` as secrets in Sites. Never place them in `catalina.html`.

13. In Stripe, create a webhook endpoint pointing to:
